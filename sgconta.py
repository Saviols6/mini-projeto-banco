...
#Mini-Projeto2 - Aplicação Full-Stack de Sistema Bancário em Python com POO
#Módulo as classes de conta

#Importando a classe base abstrata e o decorador para métodos abstratos
from abc import ABC, abstractmethod

#Importa a classe datetime para registrar data e hora
from datetime import datetime

#Importa exceção personalizada para saldo insuficiente
from sgutilitarios.sgexceptions import SaldoInsuficienteError
...
class Conta(ABC):
    ...
    #Propriedade para acesar o saldo de forma controlada
    @property
    def saldo(self):

        #Getter para o saldo, permitindo o acesso controlado.
        return self._saldo
    ...
    def depositar(self, valor:float):
        ...
        if valor > 0:
            ...
            #Registra a transação no histórico com a data e hora
    ...
    def extrato(self):
        ...
        print("Histórico das transações")

        #Caso não tenham transações registradas
...
#Define a subclassse ContaCorrente
class ContaCorrente(Conta):
    #Subclasse que representa uma conta corrente.
    #Demonstra  Polimorfismo e Encapsulamento.

    def __init__(self, numero, cliente, limite:float = 500.0):
        #Chama o consttrutor da classe base
...
class ContaPoupanca(Conta):
    ...
    def sacar(self, valor:float):
        ...
        #Registra a transação no histórico
        self._historico.append((datetime.now(),f"Saque de valor R${valor:.2f}"))
